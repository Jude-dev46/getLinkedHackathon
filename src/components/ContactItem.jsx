...
const ContactItem = () => {
  return (
    <div className="flex flex-col justify-center mt-24 lg:mt-0 relative">
      <p className="text-blue-600 text-3xl font-bold mb-4">Get in touch</p>
      ...
      <p className="text-blue-600 text-lg font-semibold mb-2">Share on</p>
