...
const Hero = () => {
  return (
    <div className=' relative bottom-10  '>
       ...
       <img src={purpleLeft} alt="purple lens flare" className="hidden lg:block absolute pointer-events-none lg:top-[-250px] lg:left-[-10px] mix-blend-hard-light" />
          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2 text-white ">
            ...
            <div className=''>
              ...
              <h1 className="text-4xl font-bold text-black sm:text-6xl lg:text-6xl">
                ...
                <img src={chainStar} alt="" className='inline-flex items-center justify-center h-10 sm:h-16' />
              </h1>
